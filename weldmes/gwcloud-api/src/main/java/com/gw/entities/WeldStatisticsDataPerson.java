 ...
 * @Description 人员生产数据实体类
 */
@Data
@ColumnWidth(20)
public class WeldStatisticsDataPerson {
     ...
     * 焊接任务数
     */
    @ExcelProperty(value = "焊接任务数",index = 3)
    private Long taskCount;

    /**
     * 使用设备数
     */
    @ExcelProperty(value = "使用设备数",index = 4)
    private Long useMachineCount;
     ...
     * 焊接时间
     */
    @ExcelProperty(value = "焊接时间",index = 6)
    private String realWeldTime;

    /**
     * 正常焊接时间
     */
    @ExcelProperty(value = "正常时间",index = 7)
    private String normalTime;

    /**
     * 焊接效率
     */
    @ExcelProperty(value = "焊接效率",index = 8)
    private Double weldingEfficiency;

    /**
     * 超规范时间
     */
    @ExcelProperty(value = "超规范时间",index = 9)
    private String supergageTime;

    /**
     * 规范符合率
     */
    @ExcelProperty(value = "规范符合率",index = 10)
    private Double standardPercentage;

    /**
     * 焊材消耗
     */
    @ExcelProperty(value = "焊材消耗",index = 11)
    private Double materialsConsumption;

    /**
     * 电能消耗
     */
    @ExcelProperty(value = "电能消耗",index = 12)
