 ...
 * @LastEditTime: 2021-09-15 11:44:20
-->
...
export default {
    ...
    methods: {
        ...
        //订阅主题
        doSubscribe () {
            this.client.subscribe('jnOtcV1CommandReturn', 0, (error, res) => {
                if (error) {
        ...
        doPublish (msg) {
            this.client.publish('jnOtcV1CommandIssue', msg, 0)
        },
        ...
        issueTimeOut () {
            this.timeout = setTimeout(() => {
                this.client.unsubscribe('jnOtcV1CommandReturn', error => {
                    console.log("取消订阅")
                    if (error) {
