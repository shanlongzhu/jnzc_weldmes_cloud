package com.gw.service.process.dispatch.service.impl;
...
import com.gw.service.process.dispatch.service.DispatchService;
...
public class DispatchServiceImpl implements DispatchService {
    ...
    public TaskInfo queryTaskInfoById(Long id) {
        ...
        return dispatchDao.queryTaskInfoById(id);
    }
    ...
    public List<TaskInfo> queryAllTaskNosOfStatusWorking() {
        ...
        return dispatchDao.queryAllTaskNosOfStatusWorking();
    }
    ...
    public List<GatherAndFirmInfo> taskStatusChange(TaskInfo taskInfo) {
        ...
        return taskClaimDao.selectFirmAndGatherNoInfosByTaskId(taskInfo.getId());
    }
