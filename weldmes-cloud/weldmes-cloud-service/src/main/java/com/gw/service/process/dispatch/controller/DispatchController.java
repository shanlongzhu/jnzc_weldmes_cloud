package com.gw.service.process.dispatch.controller;
...
import com.gw.service.config.TaskExcelListener;
...
public class DispatchController {
    ...
    public HttpResult historyTaskInfos(@RequestBody List<Integer> taskStatus) {
        List<TaskInfo> list = dispatchService.getIdAndTaskNoOfTaskInfos(taskStatus);
        return HttpResult.ok(list);
    }
}
