...
import com.gw.service.process.craft.dao.MachineWeldsxDao;
import com.gw.service.process.craft.service.MachineWeldsxService;
...
public class MachineWeldsxController {
    ...
    public HttpResult getSxProcessIssueList(@RequestParam(value = "pn", defaultValue = "1") Integer pn, Long equipType,
        ...
        PageInfo<MachineWeldsxInfo> page = new PageInfo<>(list, 10);
