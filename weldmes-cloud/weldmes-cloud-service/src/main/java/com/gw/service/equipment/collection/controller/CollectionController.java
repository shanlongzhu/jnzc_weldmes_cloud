...
import com.gw.service.config.CollectionExcelListener;
import com.gw.service.config.DownExcel;
import com.gw.entities.MachineGatherInfo;
import com.gw.service.equipment.collection.dao.CollectionDao;
...
public class CollectionController {
    ...
    public HttpResult getList(@RequestParam(value = "pn", defaultValue = "1") Integer pn,
        ...
        PageInfo<MachineGatherInfo> page = new PageInfo<>(list, 10);
