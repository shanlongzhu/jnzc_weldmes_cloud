package com.gw.service.equipment.welder.service.impl;
...
import com.gw.service.equipment.welder.dao.WelderDao;
import com.gw.service.equipment.welder.service.WelderService;
import com.gw.service.process.dispatch.dao.TaskClaimDao;
import com.gw.service.process.dispatch.service.TaskClaimService;
...
public class WelderServiceImpl implements WelderService {
     ...
     */
    @Override
    public List<MachineWeldInfo> getList(String machineNo, Integer type, Integer grade, Integer status, Integer firm, Long isNetwork, String gatherNo, String ipPath, Integer model, Integer area, Integer bay) {
    ...
    public List<MachineWeldInfo> getStatusOfMachineWeldInfos(String machineNo, Integer type, Integer grade, Integer status, Integer firm, Long isNetwork, String gatherNo, String ipPath, Integer model, Integer area, Integer bay) {
        ...
        List<MachineWeldInfo> list = welderDao.getStatusOfMachineWeldInfos(machineNo, type, grade, status, firm, isNetwork, gatherNo, ipPath, model, area, bay, time1, time2);
